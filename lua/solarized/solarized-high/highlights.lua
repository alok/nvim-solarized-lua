...
function M.load_syntax()
	...
	if g.solarized_visibility == 'high' then
		syntax['CursorLineNr'] = {guifg=colors.orange,guibg=termtrans(colors.base02),gui='bold'}
		syntax['NonText'] = {guifg=colors.orange,guibg='none',gui='bold'}
		syntax['SpecialKey'] = {guifg=colors.orange,guibg='none',gui='reverse'}
		syntax['SpellBad'] = {guifg=colors.violet,guibg=colors.base3,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellCap'] = {guifg=colors.violet,guibg=colors.base3,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellLocal'] = {guifg=colors.yellow,guibg=colors.base3,guisp=colors.red,gui='reverse,undercurl'}
		syntax['SpellRare'] = {guifg=colors.cyan,guibg=colors.base3,guisp=colors.red,gui='reverse,undercurl'}
		syntax['Title'] = {guifg=colors.yellow,guibg='none',gui='bold'}
	elseif g.solarized_visibility == 'low' then
		syntax['CursorLineNr'] = {guifg=colors.base01,guibg=termtrans(colors.base02),gui='bold'}
		syntax['NonText'] = {guifg=colors.base02,guibg='none',gui='bold'}
		syntax['SpecialKey'] = {guifg=colors.base02,guibg='none',gui='reverse'}
		syntax['SpellBad'] = {guifg=colors.violet,guibg='none',guisp=colors.orange,gui='undercurl'}
		syntax['SpellCap'] = {guifg=colors.violet,guibg='none',guisp=colors.orange,gui='undercurl'}
		...
		syntax['CursorLineNr'] = {guifg=colors.base0,guibg=termtrans(colors.base02),gui='bold'}
	...
	if g.solarized_statusline == 'low' then
		syntax['StatusLine'] = {guifg=colors.base01,guibg=colors.base3,gui='reverse'}
	...
	elseif g.solarized_statusline == 'flat' then
		syntax['StatusLine'] = {guifg=colors.base02,guibg=colors.base3,gui='reverse'}
		syntax['StatusLineNC'] = {guifg=colors.base02,guibg=colors.base1,gui='reverse'}
		syntax['TabLineSel'] = {guifg=colors.base3,guibg=colors.base02,gui='none'}
	...
	syntax['PmenuSbar'] = {guifg='none',guibg=colors.base0,gui='none'}
	syntax['PmenuSel'] = {guifg=colors.base3,guibg=colors.base01,gui='none'}
	...
	syntax['WildMenu'] = {guifg=colors.base3,guibg=colors.base02,gui='reverse'}
	syntax['Comment'] = {guifg=colors.base00,guibg='none',gui=italics()}
	...
	syntax['ToolbarLine'] = {guifg='none',guibg=colors.base02,gui='none'}
	syntax['ToolbarButton'] = {guifg=colors.base1,guibg=colors.base02,gui='bold'}
