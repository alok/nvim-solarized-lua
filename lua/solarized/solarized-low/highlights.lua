...
function M.load_syntax()
	...
	syntax['Normal'] = {guifg=colors.base0,guibg=termtrans(colors.base02),gui='none'}
	...
	syntax['LineNr'] = {guifg=colors.base01,guibg=termtrans(colors.base02),gui='none'}
	syntax['Terminal'] = {guifg=fg,guibg=termtrans(colors.base02),gui='none'}
	...
	if  g.solarized_visibility == 'high' then
		...
		syntax['SpellBad'] = {guifg=colors.magenta,guibg=colors.base2,guisp=colors.violet,gui='reverse,undercurl'}
		syntax['SpellCap'] = {guifg=colors.magenta,guibg=colors.base2,guisp=colors.violet,gui='reverse,undercurl'}
		syntax['SpellLocal'] = {guifg=colors.yellow,guibg=colors.base2,guisp=colors.orange,gui='reverse,undercurl'}
	...
	elseif g.solarized_diffmode == 'low' then
		...
		syntax['DiffAdd'] = {guifg=colors.green,guibg=colors.base2,guisp=colors.green,gui='none'}
		syntax['DiffChange'] = {guifg=colors.yellow,guibg=colors.base2,guisp=colors.yellow,gui='none'}
		syntax['DiffDelete'] = {guifg=colors.red,guibg=colors.base2,gui='bold'}
		syntax['DiffText'] = {guifg=colors.blue,guibg=colors.base2,guisp=colors.blue,gui='none'}
	end

	if g.solarized_statusline == 'low' then
		syntax['StatusLine'] = {guifg=colors.base1,guibg=colors.base2,gui='reverse'}
		syntax['StatusLineNC'] = {guifg=colors.base1,guibg=colors.base01,gui='reverse'}
		syntax['TabLine'] = {guifg=colors.base1,guibg=colors.base01,gui='reverse'}
		syntax['TabLineFill'] = {guifg=colors.base1,guibg=colors.base01,gui='reverse'}
		syntax['TabLineSel'] = {guifg=colors.base1,guibg=colors.base2,gui='reverse'}
		syntax['VertSplit'] = {guifg=colors.base01,guibg=colors.base1,gui='none'}
		syntax['WildMenu'] = {guifg=colors.base00,guibg=colors.base2,gui='reverse'}
	elseif g.solarized_statusline == 'flat' then
		syntax['StatusLine'] = {guifg=colors.base3,guibg=colors.base02,gui='reverse'}
		syntax['StatusLineNC'] = {guifg=colors.base3,guibg=colors.base01,gui='reverse'}
		syntax['TabLineSel'] = {guifg=colors.base02,guibg=colors.base3,gui='none'}
		syntax['TabLine'] = {guifg=colors.base1,guibg=colors.base3,gui='none'}
		syntax['TabLineFill'] = {guifg=colors.base1,guibg=colors.base3,gui='none'}
		syntax['VertSplit'] = {guifg=colors.base1,guibg=colors.base3,gui='none'}
		syntax['WildMenu'] = {guifg=colors.base1,guibg=colors.base3,gui='reverse'}
	else
		syntax['StatusLine'] = {guifg=colors.base01,guibg=colors.base2,gui='reverse'}
		syntax['StatusLineNC'] = {guifg=colors.base0,guibg=colors.base2,gui='reverse'}
		syntax['TabLine'] = {guifg=colors.base0,guibg=colors.base2,gui='reverse'}
		syntax['TabLineFill'] = {guifg=colors.base0,guibg=colors.base2,gui='reverse'}
		syntax['TabLineSel'] = {guifg=colors.base01,guibg=colors.base2,gui='reverse'}
		syntax['VertSplit'] = {guifg=colors.base01,guibg=colors.base1,gui='none'}
		syntax['WildMenu'] = {guifg=colors.base0,guibg=colors.base2,gui='reverse'}
	end
	...
	syntax['Pmenu'] = {guifg=colors.base3,guibg=colors.base1,gui='none'}
	syntax['PmenuSbar'] = {guifg='none',guibg=colors.base00,gui='none'}
	syntax['PmenuSel'] = {guifg=colors.base3,guibg=colors.base0,gui='none'}
	...
	syntax['SignColumn'] = {guifg=colors.base00,guibg='none',gui='none'}
	syntax['Visual'] = {guifg=colors.base1,guibg=colors.base3,gui='reverse'}
	syntax['VisualNOS'] = {guifg='none',guibg=colors.base2,gui='reverse'}
	syntax['WarningMsg'] = {guifg=colors.orange,guibg='none',gui='bold'}
	syntax['Comment'] = {guifg=colors.base1,guibg='none',gui=italics()}
	...
	syntax['NormalMode'] = {guifg=colors.base01,guibg=colors.base3,gui='reverse'}
	...
	syntax['helpExample'] = {guifg=colors.base01,guibg='none',gui='none'}
	...
	syntax['vimIsCommand'] = {guifg=colors.base0,guibg='none',gui='none'}
	...
	syntax['gitcommitComment'] = {guifg=colors.base1,guibg='none',gui=italics()}
	...
	syntax['perlHereDoc'] = {guifg=colors.base1,guibg=colors.base02,gui='none'}
	syntax['perlVarPlain'] = {guifg=colors.yellow,guibg=colors.base02,gui='none'}
	syntax['perlStatementFileDesc'] = {guifg=colors.cyan,guibg=colors.base02,gui='none'}
	syntax['texstatement'] = {guifg=colors.cyan,guibg=colors.base02,gui='none'}
	syntax['texmathzonex'] = {guifg=colors.yellow,guibg=colors.base02,gui='none'}
	syntax['texmathmatcher'] = {guifg=colors.yellow,guibg=colors.base02,gui='none'}
	syntax['texreflabel'] = {guifg=colors.yellow,guibg=colors.base02,gui='none'}
	syntax['rubyDefine'] = {guifg=colors.base1,guibg=colors.base02,gui='bold'}
	syntax['rubyBoolean'] = {guifg=colors.magenta,guibg=colors.base02,gui='none'}
